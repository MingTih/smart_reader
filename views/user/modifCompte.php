...
<form  method="post" class="mx-auto w-50">
  <fieldset>
    ...
    <div class="form-group" >
      <label for="photo" class="col-form-label col-form-label-lg mt-1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Photo</font></font></label>
      <input type="text" class="form-control form-control-lg" id="photo" placeholder="Photo" name="photo">
    </div>
