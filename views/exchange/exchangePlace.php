...
//     // print_r($_GET);
//     print_r($infoDeal);
//     print_r($infoDeal[0]["point_offers"]);
//     print_r($proposer);
//     print_r($actor);
// echo "</pre>";
?>
...
<main class="container">
    ...
    <div>
        <p><?=isset($msgDisable)?$msgDisable:"";?></p>
    </div>
    ...
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmEchange" <?=!empty($msgDisable)?"disabled":"";?>>
        Accepter <?=$title?>
    </button>
