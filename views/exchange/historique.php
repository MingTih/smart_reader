...
<main class="container">
    <h1 class="text-center">Liste de toutes mes acquisitions</h1>
    ...
    <h1 class="text-center">Liste de toutes mes ventes</h1>
        ...
        <tbody>
            ...
            ?>
                <tr>
                        ...
                        <td><?=$cession['id_owner'] . " - " . $cession["owner"][0]['pseudo']?></td>
